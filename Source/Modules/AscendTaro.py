	...
	def level_up(self, user: UserData, level: int)-> bool:
		...
		if level != 5: 
			...
			text = (
				...
				"🏆 " + _("У вас $number-й уровень! Вы получаете бонус:") + "\n" + _("$bonus Дополнительных Онлайн $layout!") + "\n",
			...
			text = (
				...
				"🏆 " + _("У вас 5-й уровень! Вы получаете бонус:") + "\n" + _("$bonus Дополнительных Онлайн раскладов и 1 бесплатный расклад от Таро мастера!") + "\n",
