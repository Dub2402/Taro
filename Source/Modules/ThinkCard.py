...
class Decorators:
	...
	def inline_keyboards(self):
		...
		def about_think_card(Call: types.CallbackQuery):
			...
			text = (
			"<b>" + _("Загадай карту") + "</b>" + " - интерактивная рубрика, где каждый может, опираясь на свою интуицию, выбрать карту и раскрыть свой потенциал или же получить ответ на заданную тему." + "\n",
			_("Каждый ") + "<b>" + _("понедельник, среду и пятницу ") + "</b>"+ "наши эксперты обновляют для вас эту рубрику и стараются придумывать наиболее интересные и актуальные темы! Мы хотим сделать ваш досуг с Тароботом еще интереснее)"+ "\n",
